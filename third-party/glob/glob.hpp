// https://raw.githubusercontent.com/p-ranav/glob/refs/heads/master/single_include/glob/glob.hpp
#pragma once
#include <cassert>
#include <functional>
#include <iostream>
...
static inline bool string_replace(std::string&       str,
...
static inline bool matches(const fs::path& name, const std::string& pattern) {
  return std::regex_match(name.string(), compile_pattern(pattern));
}
